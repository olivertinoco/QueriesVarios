...
update p set p.id_vehiculo = null, p.error = 'TARJETA DUPLICADA'
from #tmp001_param p, dbo.PROG_TARJETA_MULTIFLOTA t
where rtrim(p.Nro_Tarjeta) = rtrim(t.Nro_Tarjeta)

update p set p.error = 'PLACA NO EXISTE'
