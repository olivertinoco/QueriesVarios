...
)returns @salida table(dato int)
as
begin
declare @tot int, @nro_tarjeta varchar(100), @aux varchar(max) = @data
...
insert into @salida
select coalesce((select 1 from dbo.PROG_TARJETA_MULTIFLOTA where Nro_Tarjeta = @nro_tarjeta),0)
return
end
go
...
='1457~350352|13|C0FA0BE0_5C0E_4890_820F_4|2025-11-19|0|7.2|7.1|7.5|7.7|7.8'
...
select dato from dbo.udf_duplicado_tarjeta_multiflota(@data, @Utabla)
