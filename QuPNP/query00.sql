...
-- -- =======================
-- restore database SISPAP1 from
-- disk='/var/opt/mssql/YDRAY-sispap1' with replace,
-- move 'SIAVEP' to '/var/opt/mssql/SIAVEP_01_2019.mdf',
-- move 'SIAVEP_log' to '/var/opt/mssql/SIAVEP_01_2019_log.ldf'
-- go


-- :: NOTA: PARA EL CONTAINER SQL-2019
-- restore filelistonly from
-- disk='/var/opt/mssql/YDRAY-sispap1'
